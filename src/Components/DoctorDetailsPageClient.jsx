          ...
          <div className="flex-1">
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                ...
                <p className="text-[#4A6B6F]/70 font-medium mt-1">{doctor.specialty}</p>
                <p className="text-sm text-gray-400 mt-1">{doctor.experience} experience</p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          ...
          <div className="flex flex-col gap-6">
              ...
              <ul className="flex flex-col gap-4">
                <li className="flex items-start gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-700">{doctor.hospital}</p>
                  </div>
                </li>
                <li className="flex items-start gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-700">{doctor.location}</p>
                  </div>
                </li>
                <li className="flex items-start gap-3 text-sm">
            ...
            <div className="bg-[#4A6B6F] rounded-3xl shadow-sm p-6 flex flex-col gap-4">
              <div>
                <p className="text-[#DDE6D8]/70 text-xs uppercase tracking-widest">Consultation Fee</p>
                <p className="text-3xl font-extrabold text-white mt-1">৳{doctor.fee}</p>
              </div>
              <Link href={'/AppointmentModal'}>
              <button className="w-full bg-[#DDE6D8] text-[#4A6B6F] font-bold py-3 rounded-xl hover:bg-white transition text-sm">
                Book Appointment
              </button>
              </Link>
              <Link
